package com.ventimetriquadriconsulting.restaurant.manage_restaurant.report.entity.dto;
...
public class EmployeePresenceReportDTO {
    ...
    public EmployeePresenceReport toEntity() {
        return EmployeePresenceReport.builder()
                ...
                .employee(EmployeeDTO.toEntity(this.employee)) // Convert EmployeeDTO to entity
                .date(this.date)
