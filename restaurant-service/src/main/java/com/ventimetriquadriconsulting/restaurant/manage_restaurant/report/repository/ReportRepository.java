package com.ventimetriquadriconsulting.restaurant.manage_restaurant.report.repository;
...
public interface ReportRepository extends JpaRepository<EmployeePresenceReport, Long> {
    ...
    @Query("SELECT new com.ventimetriquadriconsulting.restaurant.manage_restaurant.report.entity.dto.EmployeeReportSummaryDTO("
            + "emp.employeeId, "
            + "emp.firstName, "
            + "emp.lastName, "
            + "emp.gender, "
            ...
            + "emp.dob, emp.startDateInduction, emp.endDateInduction, "
            + "emp.contractType, emp.phone, emp.isVisible, "
            + "emp.isFired")
