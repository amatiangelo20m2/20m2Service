package com.ventimetriquadriconsulting.restaurant.restaurant.controller;
...
public class RestaurantController {
    ...
    public ResponseEntity<EmployeeDTO> createEmployee(@PathVariable String branchCode,
    ...
    public ResponseEntity<EmployeeDTO> updateEmployee(@PathVariable String branchCode,
                                                      @RequestBody EmployeeDTO employeeDto) {
